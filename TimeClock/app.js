...
function getGroupedTimes() {
  ...
  indexed.forEach(({item,i})=>{const d=new Date(item.t); const k=`${d.getFullYear()}-${(d.getMonth()+1).toString().padStart(2,'0')}-${d.getDate().toString().padStart(2,'0')}`;
